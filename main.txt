...
perguntas = [
    ...
    {"id": "Q8", "dim": "Sustentabilidade", "txt": "Produtos/processos possuem certificações ou rastreabilidade?", "sug": "Mapear requisitos e iniciar registros digitais mínimos por lote/obra."},
    {"id": "Q9", "dim": "Normas (Guarda-corpo)", "txt": "Cálculos integrados conforme NBR 14718 (Guarda-corpo)?", "sug": "Adotar sistemas com bibliotecas digitais e laudos de impacto integrados."},
    {"id": "Q10", "dim": "Normas Técnicas", "txt": "Conformidade digital com NBR 10821 (Esquadrias) e 7199 (Vidros)?", "sug": "Implantar software que automatize o cálculo de pressão de vento e flecha."}
]
